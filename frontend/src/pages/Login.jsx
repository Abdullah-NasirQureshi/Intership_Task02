  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-primary">
      <div className="bg-secondary p-8 rounded-lg shadow-xl w-96 border border-accent/20">
        <h2 className="text-2xl font-bold mb-6 text-center text-light">Login to SISMS</h2>
        ...
        <p className="mt-4 text-center text-gray-400">
          Don't have an account? <Link to="/register" className="text-accent hover:text-light transition">Register</Link>
        </p>
      </div>
    </div>
  );
